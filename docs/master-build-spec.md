...
| D-028 | Commercial model = **license tiers** (`free`/`pro`/`agency`) resolved by `LicenseManager` → `FeatureFlags`; key **encrypted at rest**; all remote endpoints (license/update/telemetry) are **filterable and empty by default** (zero outbound calls until configured); telemetry **opt-in + anonymised**; updater is **self-hosted + license-gated**; import/export & backup share one `DataPortability` format over dynamically-discovered `bkra_` tables | Monetisation + distribution without wp.org, privacy-first by default, self-managed installs keep working offline, and one serialisation path for export/backup. | 2026-06-14 | 18 |
...
Code in [`app/Licensing/`](../app/Licensing/), [`app/Updates/`](../app/Updates/), [`app/Telemetry/`](../app/Telemetry/), [`app/Branding/`](../app/Branding/), [`app/DataTransfer/`](../app/DataTransfer/); provider in [`app/Commercial/`](../app/Commercial/); REST in [`app/API/Controllers/CommercialController.php`](../app/API/Controllers/CommercialController.php); UI in [`assets/src/admin/components/commercial/`](../assets/src/admin/components/commercial/). Decision D-028. Stage docs in [`docs/stage-18-commercial-hardening/`](stage-18-commercial-hardening/):

| Artifact | File |
|---|---|
| Stage 18 Audit & Plugin Audit Report | [stage-audit.md](stage-18-commercial-hardening/stage-audit.md) |
| Licensing + feature flags | [LicenseManager.php](../app/Licensing/LicenseManager.php) · [FeatureFlags.php](../app/Licensing/FeatureFlags.php) |
| Updater / Telemetry / White-label | [Updater.php](../app/Updates/Updater.php) · [Telemetry.php](../app/Telemetry/Telemetry.php) · [WhiteLabel.php](../app/Branding/WhiteLabel.php) |
| Import/export + backups | [DataPortability.php](../app/DataTransfer/DataPortability.php) · [BackupManager.php](../app/DataTransfer/BackupManager.php) |
| REST + provider + UI | [CommercialController.php](../app/API/Controllers/CommercialController.php) · [CommercialServiceProvider.php](../app/Commercial/CommercialServiceProvider.php) · [CommercialPage.tsx](../assets/src/admin/components/commercial/CommercialPage.tsx) |
...
Code in [`app/Reports/`](../app/Reports/), REST in [`app/API/Controllers/ReportsController.php`](../app/API/Controllers/ReportsController.php), UI in [`assets/src/admin/components/reports/`](../assets/src/admin/components/reports/). Stage docs in [`docs/stage-15-reporting/`](stage-15-reporting/):

| Artifact | File |
|---|---|
| Stage 15 Audit & Plugin Audit Report | [stage-audit.md](stage-15-reporting/stage-audit.md) |
| Report service | [ReportService.php](../app/Reports/ReportService.php) |
| REST + provider | [ReportsController.php](../app/API/Controllers/ReportsController.php) · [ReportsServiceProvider.php](../app/Reports/ReportsServiceProvider.php) |
| Admin dashboard | [ReportsPage.tsx](../assets/src/admin/components/reports/ReportsPage.tsx) |
...
Renderer in [`app/Elementor/WidgetRenderer.php`](../app/Elementor/WidgetRenderer.php) (analysed/tested), widgets in [`app/Elementor/Widgets/`](../app/Elementor/Widgets/) (PHPStan-excluded), provider in [`app/Elementor/ElementorServiceProvider.php`](../app/Elementor/ElementorServiceProvider.php). Stage docs in [`docs/stage-13-elementor/`](stage-13-elementor/):

| Artifact | File |
|---|---|
| Stage 13 Audit & Plugin Audit Report | [stage-audit.md](stage-13-elementor/stage-audit.md) |
| Widget renderer (logic) | [WidgetRenderer.php](../app/Elementor/WidgetRenderer.php) |
| Widgets | [Widgets/](../app/Elementor/Widgets/) (BookingForm, ServiceGrid, StaffGrid, Calendar, CustomerDashboard) |
| Provider | [ElementorServiceProvider.php](../app/Elementor/ElementorServiceProvider.php) |
...
Code in [`app/Integrations/`](../app/Integrations/) (Google in [`app/Integrations/Google/`](../app/Integrations/Google/)), encryption in [`app/Security/Crypto.php`](../app/Security/Crypto.php), REST in [`app/API/Controllers/GoogleCalendarController.php`](../app/API/Controllers/GoogleCalendarController.php), UI in [`assets/src/admin/components/integrations/`](../assets/src/admin/components/integrations/). Availability filter added in `AvailabilityEngine`. Stage docs in [`docs/stage-11-google-calendar/`](stage-11-google-calendar/):

| Artifact | File |
|---|---|
| Stage 11 Audit & Plugin Audit Report | [stage-audit.md](stage-11-google-calendar/stage-audit.md) |
| Crypto + token store | [Crypto.php](../app/Security/Crypto.php) · [GoogleTokenStore.php](../app/Integrations/Google/GoogleTokenStore.php) |
| Google client + sync | [GoogleClient.php](../app/Integrations/Google/GoogleClient.php) · [CalendarSyncService.php](../app/Integrations/Google/CalendarSyncService.php) |
| REST + provider | [GoogleCalendarController.php](../app/API/Controllers/GoogleCalendarController.php) · [IntegrationsServiceProvider.php](../app/Integrations/IntegrationsServiceProvider.php) |
| Admin UI | [IntegrationsPage.tsx](../assets/src/admin/components/integrations/IntegrationsPage.tsx) |
